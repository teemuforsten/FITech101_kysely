  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var $async$goto = 0,
        ...
        seuraavaButton, t1, t2, kysymykset, $async$temp1, $async$temp2;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              if (type$.List_dynamic._is(kysymykset)) {
                seuraavaButton = document.querySelector("#seuraava");
                if (seuraavaButton != null) {
                  t1 = J.get$onClick$x(seuraavaButton);
                  t2 = t1.$ti;
                  A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.main_closure(kysymykset)), false, t2._precomputed1);
                }
              }
              // implicit return
